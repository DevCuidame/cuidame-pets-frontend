...
export class UserService {
  ...
  createRelative(data, token: string = '') {
    return this.http
      .post(`${url}api/relative-cuidame/`, data, {
        headers: {
          'Content-type': 'application/json',
          Authorization: token,
        },
  ...
  updateRelative(data, id: string, token: string = '') {
    return this.http
      .put(`${url}api/relative-cuidame/${id}`, data, {
        headers: {
          'Content-type': 'application/json',
          Authorization: token,
        },
  ...
  getRelativeData(id: string) {
    return this.http
      .get(`${url}api/relative/all-data/${id}`, {})
      .pipe(catchError(this.handleError));
  }
  ...
  getPetAgreements() {
    return this.http
      .get(`${url}api/qr/petagreements`)
      .pipe(catchError(this.handleError));
  }

  animateCounter(
    target: number,
    updateFunction: (currentCount: number) => void,
