...
import { DoctorContainerLandComponent } from './modules/doctorweb/land/doctor-container-land/doctor-container-land.component';
...
const routes: Routes = [
...

  {
    path: 'petcode',
    loadChildren: () =>
      import('./pages/indetification/petcode/petcode.module').then(
        (m) => m.PetcodePageModule
      ),
  },
  {
    path: 'updateuser',
    loadChildren: () =>
      import('./pages/user-account/update-user/update-user.module').then(
